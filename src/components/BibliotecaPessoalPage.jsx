            ...
            <div className="row">
                ...
                <div className="container">
                    ...
                    <div className=" col-xs-4 col-sm-4">
                        <Link to="bibliotecapessoaldetalhe" className="thumbnail">
                            <img src="https://i.ytimg.com/vi/PtjBq2eD9ps/hqdefault.jpg" alt="..." class="img-responsive"/>
                            <div className='description'>

                                <p className='description_content'>The pack, the basic...</p>
